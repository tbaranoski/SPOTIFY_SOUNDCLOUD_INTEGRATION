#File copied from PySoundCloud folder
#Python API wrapper for web-based Soundcloud. (User must be logged in)
#Copied from https://github.com/naim-prog/soundcloud-py/tree/1c7b8373ba2586d5366c66e4619887e44e128e5d
#!!Code Modified to return json data type instead of text!!
